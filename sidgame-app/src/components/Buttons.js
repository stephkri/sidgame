export default function Buttons(props) {
  return(<div>
    <button onClick={() => {props.setSelect("Hoffman"); props.toggleMode()}}>Sid Hoffman</button>
    <button onClick={() => {props.setSelect("Frenchman"); props.toggleMode()}}>Sid Frenchman</button>
    <br />
